...
describe UsersController do
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show users followers" do
        get :followers, :id => @other_user
        response.should have_selector("a", :href => user_path(@user),
                                           :content => @user.name)
      end

      it "should show user's following" do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      it "should not have delete links for non-admins" do
        second_user = User.all.second
        get :index
        response.should_not have_selector('a',  :href => user_path(second_user),
                                                :content => "delete")
      end
    end
  end
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "bazbarblues")
      get :show, :id => @user
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      before(:each) do
        @admin = Factory(:user, :email => "wtf@example.com", :admin => true)
        test_sign_in(@admin)
      end
